...
# the focal HRL column reported with unadjusted p and per-pair n.
#
# Note for Ch 4.4/4.5: anonymity is NON-significant at the zero-order level
# (r approx -.13, p approx .13) and only turns significant in the multivariate
# model — a suppression effect, to be narrated as such, not a contradiction.
# ============================================================================
